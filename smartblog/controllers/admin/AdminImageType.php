...
class AdminImageTypeController extends ModuleAdminController
{
    ...
    public function renderList()
    {
        ...
        return  parent::renderList() . $this->setPromotion();
    }
    ...
    public function setPromotion(){
        ...
        $config_html =  $this->context->smarty->fetch(_MODULE_SMARTBLOG_ROOT_DIR_ . 'views/templates/admin/config.tpl');
        return $promotion . $config_html;
    }
