...
<div itemtype="#"  class="sdsarticleCat clearfix">
    <div id="smartblogpost-{$post.id_post|escape:'htmlall':'UTF-8'}" class="smart-blog-post-single-item">
        <div class="sdsarticleHeader smart-blog-posts-header-area">
            ...
            <span class="smart-blog-posts-info">{if $smartshowauthor ==1}{l s='Posted by'  d='Modules.Smartblog.Category_loop'}
                <span >&nbsp;<i class="icon icon-user"></i>&nbsp; {if $smartshowauthorstyle != 0}{$post.firstname|escape:'htmlall':'UTF-8'}
                ...
                &nbsp; <span class="comment">&nbsp;<i class="icon icon-comments"></i>&nbsp;
                    <a href="{$smartbloglink->getSmartBlogPostLink($post.id_post,$post.link_rewrite)|escape:'htmlall':'UTF-8'}#articleComments"
                        ...
                        class="icon icon-eye-open"></i>{l s=' views' d='Modules.Smartblog.Category_loop'}
        ...
        <div class="sdsreadMore smart-blog-post-readmore-btn">
            <a title="{$post.meta_title|escape:'htmlall':'UTF-8'}"
                ...
                class="r_more btn btn-default button button-small"><span>{l s='Read More'  d='Modules.Smartblog.Category_loop'}<i
