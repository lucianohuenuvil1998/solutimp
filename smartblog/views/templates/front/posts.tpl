...
{block name='page_content'}
				...
				<div class="smart-blog-posts-header-area">
					...
					<div class="sdsarticleHeader">
						<span class="smart-blog-posts-info">
							{if $smartshowauthor ==1} {l s='Posted by '  d='Modules.Smartblog.Posts'} &nbsp;<i class="icon icon-user"></i>
			...
			<ul class="footer_links smart-blog-posts-navigation">
				{foreach from=$posts_previous item="post"}
        			{if isset($post.id_smart_blog_post)}
						<li>
							<a title="{l s='Prevoius Post'  d='Modules.Smartblog.Posts'}" href="{$smartbloglink->getSmartBlogPostLink($post.id_smart_blog_post,$post.link_rewrite)|escape:'htmlall':'UTF-8'}" class="btn btn-default button button-small"><span><i class="icon-chevron-left"></i> {l s='Prev Post'  d='Modules.Smartblog.Posts'}</span></a>
						</li>
					{/if}
				{/foreach}
				{foreach from=$posts_next item="post"}
					{if isset($post.id_smart_blog_post)}
						<li class="pull-right">
							<a title="{l s='Next Post'  d='Modules.Smartblog.Posts'}" href="{$smartbloglink->getSmartBlogPostLink($post.id_smart_blog_post,$post.link_rewrite)|escape:'htmlall':'UTF-8'}" class="btn btn-default button button-small"><span>{l s='Next Post'  d='Modules.Smartblog.Posts'} <i class="icon-chevron-right"></i> </span></a>
						</li>
					{/if}
				{/foreach}
			</ul>
		...
		{if $countcomment != ''}
			<div id="articleComments" class="smart-blog-post-comments-view-area">
        		<h3 class="smart-blog-comments-title">{if $countcomment != ''}{$countcomment|escape:'htmlall':'UTF-8'}{else}0{/if}{l s=' Comments'  d='Modules.Smartblog.Posts'}<span></span></h3>
   				 <div id="comments">      
						...
						<div id="commentInput" class="smart-blog-commentform-input">
							<form action="" method="post" id="commentform">
								...
								<div class="smart-blog-comm-button-area">
							        <div class="submit">
										<button type="submit" name="addComment" id="submitComment" class="bbutton btn btn-default button-medium smart-blog-comment-btn" >{l s='Submit'  d='Modules.Smartblog.Posts'}</button>
									</div>
								</div>
    						</form>
						</div>
