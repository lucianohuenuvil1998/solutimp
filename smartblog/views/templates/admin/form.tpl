<div class="row justify-content-center">
    ...
    <div class="addons-controller-promotion">
      ...
      <p class="smartblog-promo-text">Don't have a purchase code??? <a href="https://classydevs.com/free-modules/smartblog/?utm_source=sbfree_backoffice&utm_medium=sbfree_backoffice&utm_campaign=sbfree_backoffice&utm_id=sbfree_backoffice&utm_term=sbfree_backoffice&utm_content=sbfree_backoffice#sb_price">GET ONE FOR!!!</a></p>
    </div>
    {/if}
