...
<div class="roja-quote-in-cart" {if $roja45_contains_quote && !$roja45_modify_quote_allowed}style="display: block"{/if}>
    ...
    <div class="roja-clear-quote text-sm-center">
        <a title="{l s='This will remove the quote from your cart.  You can add it again from your account area.' mod='roja45quotationspro'}" class="btn btn-secondary btn-clear-quote" href="#">
            {l s='Remove Quote' mod='roja45quotationspro'}
        </a>
    </div>
</div>
{/if}
