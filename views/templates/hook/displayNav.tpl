                            ...
                            <span class="remove_link">
                                {if !isset($customizedDatas.$productId.$productAttributeId) && (!isset($product.is_gift) || !$product.is_gift)}
                                    <a class="ajax_quote_block_remove_link"
                                       data-id-roja45-quotation-request = "{$product.id_roja45_quotation_request}"
                                       data-id-roja45-quotation-request-product = "{$product.id_roja45_quotation_requestproduct}"
                                       href="#"
                                       rel="nofollow"
