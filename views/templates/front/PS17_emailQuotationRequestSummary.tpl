...
{if isset($requested_products) && count($requested_products)}
<table class="table table-recap" bgcolor="#ffffff" style="width:100%;border-collapse:collapse" cellSpacing=0 cellPadding=0 border=0>
    <thead>
    <tr>
    ...
    <tr>
        ...
        <td colspan="5" style="border:1px solid #D6D4D4;text-align:center;color:#777;padding:7px 0">
            <span style="color: #333;font-family: Arial;font-size: 13px;padding: 5px;font-weight: 500;">{$product.name|escape:'html':'UTF-8'}</span><br/>
            {if isset($product.attributes) && $product.attributes}
            <span style="color: #333;font-family: Arial;font-size: 11px;padding: 5px;font-weight: 500;">{$product.attributes|escape:'html':'UTF-8'}</span><br/>
            {/if}
            {if isset($product.manufacturer)}<span style="color: #333;font-family: Arial;font-size: 10px;padding: 5px;font-weight: 300;">{$product.manufacturer|escape:'html':'UTF-8'}</span>{/if}
        </td>
        <td colspan="5" style="border:1px solid #D6D4D4;text-align:center;color:#777;padding:7px 0">
            <span style="color: #333;font-family: Arial;font-size: 13px;padding: 5px;font-weight: 500;">{if isset($product.attributes)}{$product.attributes|escape:'html':'UTF-8'}{/if}</span>
        </td>
        <td colspan="5" style="border:1px solid #D6D4D4;text-align:center;color:#777;padding:7px 0">
        ...
        <td colspan="5" style="border:1px solid #D6D4D4;text-align:center;color:#777;padding:7px 0">
            <span style="color: #333;font-family: Arial;font-size: 13px;padding: 5px;font-weight: 500;">{$product.cart_quantity|escape:'html':'UTF-8'}</span>
        </td>
    </tr>
    {/foreach}
</table>
