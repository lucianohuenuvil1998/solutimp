...
{block name="page_title"}
    <h4>{l s='quote history' d='Modules.Roja45quotationspro.Shop'}</h4>
{/block}
...
{block name='page_content'}
            ...
            <div class="flex-table" role="rowgroup">
                <div class="column">
                    <div class="flex-row header">
                        <div class="flex-cell first" role="columnheader">{l s='reference' d='Modules.Roja45quotationspro.Shop'}</div>
                        <div class="flex-cell" role="columnheader">{l s='requested' d='Modules.Roja45quotationspro.Shop'}</div>
                        <div class="flex-cell" role="columnheader">{l s='expired' d='Modules.Roja45quotationspro.Shop'} </div>
                        <div class="flex-cell" role="columnheader">{l s='purchased' d='Modules.Roja45quotationspro.Shop'} </div>
                    </div>
    ...
    {else}
        <div class="box">
            <p class="warning">{l s='You have no historical quotes.' d='Modules.Roja45quotationspro.Shop'}</p>
        </div>
    {/if}
{/block}
