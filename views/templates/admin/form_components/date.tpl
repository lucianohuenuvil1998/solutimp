...
<div id="DATE" class="field_elements_form defaultForm form-horizontal" data-action="{$url|escape:'html':'UTF-8'}" style="display:none;">
    <form id="date_field_form" method="post" data-form-type='DATE' enctype="multipart/form-data" novalidate="">
