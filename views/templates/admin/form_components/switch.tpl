...
<div id="SWITCH" class="field_elements_form defaultForm form-horizontal" data-action="{$url|escape:'html':'UTF-8'}" style="display:none;">
    <form id="switch_field_form" method="post" enctype="multipart/form-data" novalidate="" data-form-type='SWITCH'>
        <div class="panel" id="checkbox_field_element">
            <div class="panel-heading">
                <i class="icon-cogs"></i>{l s='Switch Field Settings' mod='roja45quotationspro'}
            </div>
            ...
            <div class="form-wrapper">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9 ">
                        <select name="form_element_required" class="fixed-width-xl">
                            <option value="1">{l s='On' mod='roja45quotationspro'}</option>
                            <option value="0" selected="selected">{l s='Off' mod='roja45quotationspro'}</option>
                        </select>
                    </div>
                </div>
                {include
