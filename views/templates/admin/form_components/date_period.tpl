...
<div id="DATEPERIOD" class="field_elements_form defaultForm form-horizontal" data-action="{$url|escape:'html':'UTF-8'}" style="display:none;">
    <form id="date_field_form" method="post" data-form-type='DATEPERIOD' enctype="multipart/form-data" novalidate="">
        <div class="panel" id="date_field_element">
            <div class="panel-heading">
                <i class="icon-cogs"></i>{l s='Date Field Settings' mod='roja45quotationspro'}
            </div>
            ...
            <div class="form-wrapper">
                ...
                {include
                    ...
                    field_languages=$languages
                    default_lang=$defaultFormLanguage
                    id='form_element_start_label'
                    field_label={l s='Start Label' mod='roja45quotationspro'}
                    required='0'
                    validationMethod='isText'
                    maxlength='255'
                    placeholder={l s='Enter Your Start Field Label' mod='roja45quotationspro'}
                }
                {include
                    file='./text_field.tpl'
                    field_languages=$languages
                    default_lang=$defaultFormLanguage
                    id='form_element_end_label'
                    field_label={l s='End Label' mod='roja45quotationspro'}
                    required='0'
                    validationMethod='isText'
                    maxlength='255'
                    placeholder={l s='Enter Your End Field Label' mod='roja45quotationspro'}
                }
                {include
                    file='./text_field.tpl'
