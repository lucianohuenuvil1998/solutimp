...
<table id="body" style="margin: 0;" border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td colspan="12">
            ...
            <p>We are pleased to provide you with a quote as follows:</p>
        </td>
    </tr>
    <tr>
        <td colspan="12" height="20">&nbsp;</td>
        ...
        <td colspan="12">
            <table id="summary-tab" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <th class="header summary center">Expires</th>
                </tr>
                <tr>
...
<table id="product-tab" class="product" width="100%">
    <tbody>
    <tr class="product product-header" style="height: 20px;">
        <th class="product header" width="11%">&nbsp;</th>
        <th class="product header" width="12%">Product</th>
        <!--{if $show_product_customizations}-->
        <th class="product header" width="13%">Customizations</th>
        <!--{/if}--> <!--{if $show_product_comments}-->
        <th class="product header" width="13%">Comment</th>
        <!--{/if}-->
        <th class="product header" width="7%">Price @@tax_text@@</th>
        <!--{if $show_product_discounts}-->
        <th class="product header" width="5%">Discounts</th>
        <!--{/if}-->
        <th class="product header" width="7%">Offer @@tax_text@@</th>
        <!--{if $show_customization_cost}-->
        <th class="product header" width="7%">Customization @@tax_text@@</th>
        <!--{/if}-->
        <th class="product header" width="6%">Quantity</th>
        <th class="product header" width="7%">Total @@tax_text@@</th>
        <th class="product header" width="6%">Tax</th>
        <th class="product header" width="6%">Rate</th>
        <!--{if $show_ecotax}-->
        <th class="product header" width="6%">Ecotax</th>
        <!--{/if}--></tr>
    ...
    <tr class="product product-row align-center" data-do-not-remove="true">
        ...
        <!--{if $show_product_discounts}-->
        <td class="product center">@@product_discount_prefix@@@@product_discount@@@@product_discount_postfix@@</td>
        <!--{/if}-->
        ...
        <!--{if $show_ecotax}-->
        <td class="product center">@@product_ecotax@@</td>
        <!--{/if}--></tr>
...
<table id="tax-summary-tab" class="tax-summary" width="100%">
    <tbody>
    <tr>
        <th class="taxes header center">Tax Summary</th>
        <th class="taxes header scentermall">Total (exc.)</th>
        <th class="taxes header scentermall">Tax</th>
        <th class="taxes header scentermall">Total (inc.)</th>
    </tr>
    ...
    <tr class="additionals-row">
        <td class="charges">
            <table id="charges-tab">
                <tbody>
                <tr>
                    <th class="charge header center">Shipping</th>
                    <th class="charge header center">Delay</th>
                    <th class="charge header center">Total @@tax_exc_text@@</th>
                    <th class="charge header center">Tax</th>
                    <th class="charge header center">Total @@tax_inc_text@@</th>
                </tr>
                <!-- foreach shipping -->
                <tr>
        ...
        <td class="discounts">
            <table id="discounts-tab">
                <tbody>
                <tr>
                    <th class="discount header center">Discount</th>
                    <th class="discount header center">Total @@tax_exc_text@@</th>
                    <th class="discount header center">Tax</th>
                    <th class="discount header center">Total @@tax_inc_text@@</th>
                </tr>
                <!-- foreach discounts -->
                <tr>
                    <td class="discount center">@@discount_name@@</td>
                    <td class="discount center">@@discount_amount_exc@@</td>
                    <td class="discount center">@@discount_amount_tax@@</td>
                    <td class="discount center">@@discount_amount_inc@@</td>
                </tr>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <!--{/if}--> <!--{if $show_customization_cost}-->
    <tr id="total_customization">
        <td style="width: 50%;">&nbsp;</td>
        <th class="header-left" style="width: 25%;">Customization @@tax_text@@</th>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td class="notes">
            <p class="note">- Prices are valid until the provided quotation expiry date.</p>
            <p class="note">- If you are unsure of the information or prices provided, please do not hesitate to contact us.</p>
            <p class="note">- Your quote has been provided in your requested currency. Please be aware that currency fluctuations may result in changes to the price you have been quoted. We reserve the right to change or cancel this quote at any time.</p>
        </td>
    </tr>
    </tbody>
</table>
