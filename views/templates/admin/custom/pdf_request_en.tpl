...
<!--{/if}--> <!--{if $show_prices}-->
<td class="product center" style="border-right: 1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC; font-size: 9px; text-align: center;" align="center">@@product_list_price@@</td>
<!--{/if}-->
