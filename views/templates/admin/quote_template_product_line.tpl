...
<tr>
    <td colspan=1 style="border:0px solid #D6D4D4;border-bottom:1px solid #D6D4D4;">
        {if isset($product.image) && $product.image->id}<img src="{$product.image_tag|escape:'html':'UTF-8'}" alt="{$product['product_title']|escape:'html':'UTF-8'}" class="img img-thumbnail" width="{$product['image_width']|escape:'htmlall':'UTF-8'}" height="{$product['image_height']|escape:'htmlall':'UTF-8'}"/>{/if}
    </td>
    ...
    {if $quotation->calculate_taxes}
        ...
        <td align="center" colspan=2 style="border:0px solid #D6D4D4;border-bottom:1px solid #D6D4D4;">
            <span style="color: #444444;font-family: Helvetica, 'Open Sans', Arial, sans-serif;font-size: 13px;">{$product.tax_paid_formatted|escape:'htmlall':'UTF-8'}</span>
        </td>
        <td align="center" colspan=2 style="border:0px solid #D6D4D4;border-bottom:1px solid #D6D4D4;">
            <span style="color: #444444;font-family: Helvetica, 'Open Sans', Arial, sans-serif;font-size: 13px;">{$product.tax_rate_formatted|escape:'htmlall':'UTF-8'}</span>
        </td>
    {else}
        <td align="center" colspan=2 style="border:0px solid #D6D4D4;border-bottom:1px solid #D6D4D4;">
