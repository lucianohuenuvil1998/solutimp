...
{if ($show_taxes)}
    ...
    {l s='Sub-Total Products' mod='roja45quotationspro'}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$total_products_inc_formatted|escape:'htmlall':'UTF-8'}
    {l s='Discounts' mod='roja45quotationspro'}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$total_discounts_inc_formatted|escape:'htmlall':'UTF-8'}
    {l s='Total Products' mod='roja45quotationspro'}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$total_products_after_discount_wt_formatted|escape:'htmlall':'UTF-8'}
    {l s='Charges (inc.tax)' mod='roja45quotationspro'}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$total_charges_inc_formatted|escape:'htmlall':'UTF-8'}
    {l s='Shipping (inc.tax)' mod='roja45quotationspro'}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$total_shipping_inc_formatted|escape:'htmlall':'UTF-8'}
    {l s='Handling (inc.tax)' mod='roja45quotationspro'}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$total_handling_inc_formatted|escape:'htmlall':'UTF-8'}
...
{else}
    ...
    {l s='Discounts' mod='roja45quotationspro'}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$total_discounts_exc_formatted|escape:'htmlall':'UTF-8'}
    {l s='Total Products' mod='roja45quotationspro'}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$total_products_after_discount_wt_formatted|escape:'htmlall':'UTF-8'}
    {l s='Charges (exc.tax)' mod='roja45quotationspro'}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$total_charges_exc_formatted|escape:'htmlall':'UTF-8'}
    {l s='Shipping (exc.tax)' mod='roja45quotationspro'}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$total_shipping_exc_formatted|escape:'htmlall':'UTF-8'}
    {l s='Handling (exc.tax)' mod='roja45quotationspro'}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$total_handling_exc_formatted|escape:'htmlall':'UTF-8'}
